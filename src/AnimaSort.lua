ANIMASORT_SLUG, ANIMASORT = ...
ANIMASORT_MSG_VERSION = GetAddOnMetadata( ANIMASORT_SLUG, "Version" )
ANIMASORT_MSG_ADDONNME = GetAddOnMetadata( ANIMASORT_SLUG, "Title" )
ANIMASORT_MSG_AUTHOR = GetAddOnMetadata( ANIMASORT_SLUG, "Author" )
